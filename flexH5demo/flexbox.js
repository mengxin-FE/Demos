...
!function(e, t) {
    ...
    if (!m && !s) {
        ...
        m = v ? h >= 3 && (!m || m >= 3) ? 3 : h >= 2 && (!m || m >= 2) ? 2 : 1 : 1,
        s = 1 / m
    }
    ...
    !o)
        ...
        o.setAttribute("content", "initial-scale=" + s + ", maximum-scale=" + s + ", minimum-scale=" + s + ", user-scalable=no"),
        n.firstElementChild)
